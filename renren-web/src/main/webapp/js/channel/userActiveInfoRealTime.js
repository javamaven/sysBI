...
function initExportFunction(){
	$('#btn_exports').click(function(){
		...
		executePost('../channel/manager/exportExcelRealTime', {'params' : JSON.stringify(params)});  
	});
...
function initTimeCond(){
    ...
    $("#start_register_time").val(getCurrDate());
...
//				{ label: '邀请人ID', name: 'spreadsUserid', index: '$USER_ID', width: 80,align:'right' }, 	
				{ label: 'SEM关键字', name: 'semKeyword', index: '$USER_ID', width: 80,align:'right' }, 	
...
//				{ label: '渠道负责人', name: 'channelHead', index: '$CHANNEL_NAME', width: 100,align:'right' }, 	
				...
				{ label: '渠道标记', name: 'channelLabel', index: '$CHANNEL_MARK', width: 80,align:'right' }, 	
//				{ label: '手机号码', name: 'phone', index: '$PHONE', width: 100,align:'right' },
				{ label: '注册时间', name: 'registerTime', index: '$REGISTER_TIME', width: 80,align:'right' }		
...
//			$("#mask").show();
			...
			var page = $("#jqGrid").jqGrid('getGridParam','page');
			 $("#jqGrid").jqGrid('setGridParam',{  
	            datatype:'json', 
	            url: '../channel/manager/listRealTime',
