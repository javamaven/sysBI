...
function initTableGrid(){
    ...
    $('#reportTable').bootstrapTable({
        url: "../dmreportinsidelx/list", //请求后台的URL（*）
...
//        cardView: false,                    //是否显示详细视图
        ...
        columns:  [
            ...
            {field:"lxName",title:"员工姓名",align:"center",valign:"middle",sortable:"true"},//居中对齐
            {field:"laxDep",title:"　　　部门　　　",align:"center",valign:"middle",sortable:"true"},//居中对齐
            {field:"lxUserCou",title:"当季度有效拉新人数",align:"center",valign:"middle",sortable:"true"},//居中对齐
            {field:"lxUserTg",title:"当季度拉新目标人数",align:"center",valign:"middle",sortable:"true"},
            {field:"reach",title:"当季度有效拉新人数指标达成率",align:"center",valign:"middle",sortable:"true"},
            {field:"lxDs",title:"满足日均待收金额的人数",align:"center",valign:"middle",sortable:"true"},
            {field:"lxUserPw",title:"当季度累计有效拉新人数排名",align:"center",valign:"middle",sortable:"true"},
            {field:"jf",title:"季度度新增积分值",align:"center",valign:"middle",sortable:"true"},
            {field:"jfpw",title:"季度度新增积分值排名",align:"center",valign:"middle",sortable:"true"}
