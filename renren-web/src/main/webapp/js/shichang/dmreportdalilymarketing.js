...
function initDayTable(){
    $("#jqGrid_day").jqGrid({
        ...
        datatype: "json",
        colModel: [			
			{ label: '日期', name: 'statPeriod', index: '$STAT_PERIOD', width: 80,align:'right', key: true },
			{ label: '注册人数', name: 'regNum', index: '$REG_NUM', width: 80,align:'right' }, 			
			{ label: '实名人数', name: 'authNum', index: '$AUTH_NUM', width: 80,align:'right' }, 			
			{ label: '首投人数', name: 'firstInvNum', index: '$FIRST_INV_NUM', width: 80,align:'right'  }, 			
			{ label: '充值人数', name: 'reNum', index: '$RE_NUM', width: 80,align:'right'  }, 			
			{ label: '投资人数', name: 'invNum', index: '$INV_NUM', width: 80 ,align:'right' }, 			
			{ label: '首投金额', name: 'invFirstMoney',align:'right', index: '$INV_FIRST_MONEY', width: 100 , formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}    }, 			
			{ label: '年化首投金额', name: 'yInvFirstMoney',align:'right', index: '$Y_INV_FIRST_MONEY', width: 100, formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}  }, 			
			{ label: '投资金额', name: 'invMoney',align:'right', index: '$INV_MONEY', width: 100, formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}  }, 			
			{ label: '年化投资金额', name: 'yInvMoney',align:'right', index: '$Y_INV_MONEY', width: 110, formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}  }, 			
			{ label: '充值金额', name: 'reAmount',align:'right', index: '$RE_AMOUNT', width: 110, formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}  }, 			
			{ label: '提现金额', name: 'wiAmount',align:'right', index: '$WI_AMOUNT', width: 110, formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}  }, 			
			{ label: '充提差', name: 'pureRecharge',align:'right', index: '$PURE_RECHARGE', width: 110, formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}  }, 			
			{ label: '当日注册当日充值', name: 'dayReAmount',align:'right', index: '$DAY_RE_AMOUNT', width: 140 , formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}} }, 			
			{ label: '当日注册当日投资', name: 'dayInvMoney',align:'right', index: '$DAY_INV_MONEY', width: 140, formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}  }, 			
			{ label: '渠道注册人数', name: 'cRegNum', align:'right',index: '$C_REG_NUM', width: 100 }, 			
			{ label: '渠道实名人数', name: 'cAuthNum',align:'right', index: '$C_AUTH_NUM', width: 100 }, 			
			{ label: '渠道首投人数', name: 'cFirstInvNum', align:'right',index: '$C_FIRST_INV_NUM', width: 100 }, 			
			{ label: '渠道首投金额', name: 'cInvFirstMoney',align:'right', index: '$C_INV_FIRST_MONEY', width: 100, formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}  }, 			
			{ label: '年化渠道首投金额', name: 'yCInvFirstMoney',align:'right', index: '$Y_C_INV_FIRST_MONEY', width: 130, formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}  }, 			
			{ label: '渠道投资金额', name: 'cInvMoney',align:'right', index: '$C_INV_MONEY', width: 100, formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}  }, 			
			{ label: '渠道年化投资金额', name: 'yCInvMoney',align:'right', index: '$Y_C_INV_MONEY', width: 140 , formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}} }, 			
			{ label: '当月首投用户当日投资', name: 'mInvMoney',align:'right', index: '$M_INV_MONEY', width: 160, formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}  },
			{ label: '渠道费用', name: 'cCost',align:'right', index: '$M_INV_MONEY', width: 160, formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}  },
			{ label: '渠道充值', name: 'cRecharge',align:'right', index: '$M_INV_MONEY', width: 160, formatter:function(cellvalue, options, rowObject){if(cellvalue){return formatNumber(cellvalue,2);}else{return '';}}  }
        ],
