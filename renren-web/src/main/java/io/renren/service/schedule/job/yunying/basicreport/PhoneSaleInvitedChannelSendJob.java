...
public class PhoneSaleInvitedChannelSendJob implements Job {
	...
	private boolean run(JobExecutionContext ctx) {
		...
		log.info("+++++++++PhoneSaleInvitedChannelSendJob+++++++++++++" + taskEntity);
...
//			List<Map<String, Object>> dataList = service.queryRegisterThreeDaysNotInvestList(queryParams);
			PageUtils pageutils = service.queryInvitedChannelList(1, 100000, registerStartTime, registerEndTime, 0, 100000, "");
