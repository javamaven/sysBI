...
//			Integer limit = Integer.parseInt(params.get("limit") + "");
			...
			PageUtils pages = service.query(1, 1000*10000, statPeriod, afterInvestBalance_start, afterInvestBalance_end,
					startFirstInvestTime, endFirstInvestTime, startTotalMoney, endTotalMoney, startTotalInvestAmount,
					endTotalInvestAmount, startFirstInvestAmount, endFirstInvestAmount, startRegisterTime,
					endRegisterTime, bangCard, realName, channelName);
